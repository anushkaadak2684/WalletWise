...
public class LoginPanel extends JPanel {
    ...
    private void handleLogin() {
        ...
        try {
            User user = parentFrame.getUserService().getUserByEmail(email);
            if (user == null) {
                UIHelper.showError(this, "No user account found with email: " + email);
                return;
            }

            if (!user.getPassword().equals(password)) {
                UIHelper.showError(this, "Incorrect password.");
                return;
            }
